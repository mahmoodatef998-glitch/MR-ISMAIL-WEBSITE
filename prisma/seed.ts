...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      category: 'Smartphones',
      brand: 'Samsung',
      description: 'Samsung Galaxy A55 5G with 50MP OIS camera, 5000mAh battery, IP67 dust/water resistance, and Super AMOLED display.',
    ...
    },
    {
      ...
      descriptionAr: 'محول الشحن السريع الرسمي من سامسونج 25 واط USB-C. متوافق مع جميع أجهزة سامسونج جالاكسي.',
      specs: JSON.stringify([
    ...
    },
    {
      ...
      descriptionAr: 'آبل AirPods Pro الجيل الثاني مع خاصية إلغاء الضوضاء النشط والصوت التكيفي وعمر بطارية يصل إلى 30 ساعة.',
      specs: JSON.stringify([
    ...
    },
    {
      ...
      category: 'Accessories',
      brand: 'Anker',
      description: 'Anker 737 Power Bank with 140W PD charging, 20000mAh capacity, USB-C + USB-A ports, and digital display.',
      descriptionAr: 'باور بنك أنكر 737 مع شحن PD بقدرة 140 واط وسعة 20000 مللي أمبير ومنافذ USB-C + USB-A.',
      specs: JSON.stringify([
    ...
    },
    {
      ...
      descriptionAr: 'مجموعة استبدال شاشة AMOLED أصلية لسامسونج جالاكسي S24 تتضمن اللاصق والأدوات ودليل التركيب.',
      specs: JSON.stringify([
    ...
    },
    {
      ...
      category: 'Spare Parts',
      brand: 'Apple',
      description: 'OEM iPhone 15 battery replacement with original 3877mAh capacity. Professional repair shop supply with health certificate.',
      descriptionAr: 'بطارية آيفون 15 البديلة من OEM بسعة أصلية 3877 مللي أمبير. للتوريد لمحلات الإصلاح المحترفة.',
      specs: JSON.stringify([
