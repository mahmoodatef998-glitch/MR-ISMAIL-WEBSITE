  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-2">
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#c8a96e] to-[#e8c97a] flex items-center justify-center shadow-lg shadow-[#c8a96e]/20">
                ...
                {links.map((l) => (
                  <li key={l.id}>
                    <a
                      ...
                      className="text-sm text-gray-500 hover:text-[#c8a96e] transition-colors duration-200"
                    >
                      {lang === 'ar' ? l.ar : l.en}
                    </a>
                  </li>
            ...
            <div>
              ...
              <div className="mt-8 space-y-1.5">
                {['Authorized Samsung Distributor', 'ISO 9001:2015', 'DED Licensed'].map((b) => (
                  <div key={b} className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-[#c8a96e]/6 border border-[#c8a96e]/12 rounded-full text-[10px] font-medium text-[#c8a96e] mr-1.5">
                    {b}
                  </div>
                ))}
              </div>
          ...
          {/* Bottom bar */}
          <div className="mt-12 pt-6 border-t border-white/[0.05] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-600">
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-2xl shadow-[#25D366]/30 bg-[#25D366] hover:bg-[#20bd5a] hover:scale-110 transition-all duration-300"
      >
